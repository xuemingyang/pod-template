...
module Pod
  class TemplateConfigurator
    ...
    def run
      ...
      platform = self.ask_with_answers("What platform do you want to use?", ["iOS"]).to_sym

      case platform
        when :macos
          ConfigureMacOSSwift.perform(configurator: self)
        when :ios
          framework = self.ask_with_answers("What language do you want to use?", ["Swift"]).to_sym
       case framework
            when :swift
